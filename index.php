...
<html lang="es">
    <head>
        ...
        <meta name="description" content="Fryntiz Desarrollador de
                                          aplicaciones WEB, página oficial" />
        <meta name="keywords" content="curriculum, fryntiz, programador,
                                       desarrollador, página web, web,
                                       online, curriculum online,
                                       desarrollador web, sitio web, raul,
                                       raul caro pastorino, Raúl Caro
                                       Pastorino, Raúl, Raúl Caro, Caro
                                       Pastorino, web developer, developer,
                                       crear página, crear página web, hacer
                                       página web" />
