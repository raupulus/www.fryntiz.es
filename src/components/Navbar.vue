<template>
    <nav class="box-navbar fixed w-full top-0 flex items-center justify-between flex-wrap
p-2 navbar-main">
    ...
    <div class="box-nav-menu-mobile w-full flex-grow text-center lg:flex lg:items-center lg:w-auto"
         :class="mobileMenuIsOpen ? '' : 'hidden'">

        <div class="text-sm lg:flex-grow">
            <router-link v-for="(link, name) of links"
                         :to="link" 
                         :key="name"
